...
def getTags(arg, argsList): #input: string arg and list argsList
    ...
    flag_nns = flag_nn = flag_nnp = flag_nnps = flag_vb = flag_prp = flag_noun = flag_nounproper = ''
    for a in argsList: #[srl.wordid, srl.srlword, srl.srlresult[column], ner, pos, pos tag google]
        ...
        if (a[5]) == 'PROPN':
            if (a[4]) == 'NNP' or (a[4]) == 'NNSP' :
                if tags.nounproper == '': #first word
                    tags.nounproper = tags.nounproper + a[1] + ' '
                    flag_nounproper = a[5]
                elif flag_nounproper == a[5]:
                    tags.nounproper = tags.nounproper + a[1] + ' '
        else:
            flag_nounproper = ''
    ...
    tags.nounproper=tags.nounproper.rstrip()
...
def checkTemplate(srlObjectList): #input: sentenceListForQA[i] or sentenceList[i] 
    ...
    if columnLen == 0: # if there are no SRL results
        ...
        if argTags.location != '':
           ...
           qa.append (['Who is ' +  argTags.person + '?','WHO1'])
            ...
            qa.append(['Which ' + argTags.nns + ' do you like?','WHC1']) 
            ...
            try:
                ...
                for ao in argumentOrdered: #loop per subclause in arg        
                    if argumentOrdered[c][0] == 'A0':
                        ...
                        Arg_2 = True
                        Arg_2_words = str(argumentOrdered[c][1]).rstrip() # remove spaces at the end of the string
                        Arg_2_words = re.sub(r'\s([?.,!"](?:\s|$))', r'\1', Arg_2_words) # remove spaces before punctuation
                ...
                if seq_in_seq (['AM-NEG'] , arg_sequence) == False:
                                ...
                                for tag in argTags:
                                    if tag.arg == 'A1':
                                        ...
                                        if seq_in_seq (['AM-TMP','V','A1'] , arg_sequence) == True and Vtag == 'VBD': #if len(argumentordered) > 1 and ArgM_TMP has something and ArgTMP is followed by V
                                            if Arg_0 == True:
                                                qa.append(['When did ' + Arg_0_words + ' '+ getLemma(V) + ' ' + item_no_comma(Arg_1_words) + '?', 'WHN1']) 
                                        ...
                                        if Arg_0 == True and Arg_2 == False and Arg_3 == False and Arg_4 == False:                                        
                                            ...
                                            if seq_in_seq (['AM-TMP'] , arg_sequence) == False:
                                                if (Vtag == 'VBD' or Vtag == 'VBN'):
                                                    qa.append(['When did ' + Arg_0_words + ' ' + getLemma(V) + ' ' + item_no_comma(Arg_1_words) + '?','WHN3'])
                                                elif (Vtag == 'VBP' or Vtag == 'VBZ' or Vtag == 'VBG' or Vtag == 'VB'):
                                                    qa.append(['When ' + aux + ' ' + Arg_0_words + ' usually ' + getLemma(V) + ' ' + item_no_comma(Arg_1_words) + '?','WHN3'])
                                ...
                                if tag.arg != 'A0':
                                    for tag in argTags:
                                        if tag.location != '':  
                                            ...
                                            qa.append (['Where is ' + tag.nounproper + '?','WHR1'])
                                        elif seq_in_seq (['IN','NNPS'] , tag.tag_seq) == True: 
                                             qa.append (['What do you think about ' + tag.nounproper + '?','WHT9'])
                            else: 
                    ...
                    if Arg_1_words == '' or Arg_0_words == '' or Arg_2_words == '' :
                        ...
                        elif argumentOrdered[0][0] == 'A2':
                            Arg_2_words = str(argumentOrdered[0][1]).rstrip()
                    ...
                    if seq_in_seq (['AM-MOD'] , arg_sequence) == True:
                        if seq_in_seq (['A0'] , arg_sequence) == True and seq_in_seq (['A1'] , arg_sequence) == False and seq_in_seq (['AM-PNC'] , arg_sequence) == False  and seq_in_seq (['AM-CAU'] , arg_sequence) == False:
                            if ArgM_MOD == 'can':
                                qa.append (['Why '+ ArgM_MOD + '\'t '  +  Arg_0_words + '?','NEG6'])
                            if ArgM_MOD == 'will':
                                qa.append (['Why won\'t '  +  Arg_0_words + '?','NEG6'])
                            else:
                                qa.append (['Why '+ ArgM_MOD + 'n\'t '  +  Arg_0_words + '?','NEG6'])
                            ...
                            if ArgM_MOD == 'can':
                                if Arg_2_words != '':
                                    qa.append (['Why '+ ArgM_MOD + '\'t '  +  Arg_1_words +' ' + getLemma(V) + ' ' + Arg_2_words + '?','NEG4'])
                                else:
                                    qa.append (['Why '+ ArgM_MOD + '\'t '  +  Arg_1_words +' ' + getLemma(V)+ '?','NEG4'])
                            elif ArgM_MOD == 'will':
                                if Arg_2_words != '':
                                    qa.append (['Why won\'t '  +  Arg_1_words +' ' + getLemma(V) + ' ' + Arg_2_words + '?','NEG4'])
                                else:
                                    qa.append (['Why won\'t '  +  Arg_1_words +' ' + getLemma(V)+ '?','NEG4'])
                            else:
                                if Arg_2_words != '':
                                    qa.append (['Why '+ ArgM_MOD + 'n\'t '  +  Arg_1_words +' ' + getLemma(V) + ' ' + Arg_2_words + '?','NEG4']) 
                                else:
                                    qa.append (['Why '+ ArgM_MOD + 'n\'t '  +  Arg_1_words +' ' + getLemma(V)+ '?','NEG4'])                               
                            ...
                            if ArgM_MOD == 'will':
                                qa.append (['Why won\'t '  +  Arg_0_words + ' ' + getLemma(V) + ' ' + Arg_1_words +  '?','NEG5'])
                            else:
                        ...
                        if seq_in_seq (['A0'] , arg_sequence) == True and seq_in_seq (['A1'] , arg_sequence) == True and seq_in_seq (['AM-PNC'] , arg_sequence) == False  and seq_in_seq (['AM-CAU'] , arg_sequence) == False: 
                            ...
                            if seq_in_seq (['PRP', 'VBD'] , pos_sequence) == True or seq_in_seq (['PRP', 'VBN'] , pos_sequence) == True:
                                if Arg_2_words != '':
                                    qa.append (['Why did' + 'n\'t ' + Arg_1_words + ' ' + getLemma(V) + ' ' + Arg_2_words + '?','NEG2'])
                                else:
                                    qa.append (['Why did' + 'n\'t ' + Arg_1_words + ' ' + getLemma(V) + '?','NEG2'])
                                ...
                                if Arg_2_words != '':
                                    qa.append (['Why ' + aux + 'n\'t '  + Arg_1_words + ' ' + getLemma(V) + ' ' + Arg_2_words + '?','NEG2'])  
                                else:   
                                    qa.append (['Why ' + aux + 'n\'t '  + Arg_1_words + ' ' + getLemma(V) + '?','NEG2'])                                                                
                            ...
                            if seq_in_seq (['PRP', 'VBD'] , pos_sequence) == True or seq_in_seq (['PRP', 'VBN'] , pos_sequence) == True:
                                qa.append (['Why did' + 'n\'t ' + Arg_0_words + '?','NEG3'])
                            elif seq_in_seq (['PRP', 'VBP'] , pos_sequence) == True or seq_in_seq (['PRP', 'VBZ'] , pos_sequence) == True or seq_in_seq (['PRP', 'VBZ'] , pos_sequence) == True or seq_in_seq (['PRP', 'VB'] , pos_sequence) == True:
                                qa.append (['Why ' + aux + 'n\'t '  + Arg_0_words + '?','NEG3'])
    ...
    if len(qa) == 0:
        ...
        elif argTags.nounproper != '':
            qa.append (['What do you think about ' +  argTags.nounproper + '?','WHT8'])
        elif Arg_0 == True:
            #if Vtag == 'VBP':
                #qa.append ([aux + ' ' + Arg_0_words + '?','IST1'])
            if Vtag == 'VBD':
                qa.append (['Did ' + Arg_0_words+ '?','DEF7a'])
            else:
                qa.append(['How is that going for ' + Arg_0_words +'?','DEF7b'])
        else:
